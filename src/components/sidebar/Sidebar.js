  ...
  return (
    <>
      <aside
        class={twFormater({
          base:
            'sidebar w-64 p-2 transform -translate-x-full transition-transform duration-150 ease-in',
      ...
      >
        ...
        <div class="sidebar-content px-4 py-6 -my-8 text-white font-mono">
          <h1 class="text-center">{globalConstants.userName}</h1>
          <h4 class="text-center">{globalConstants.shortName}</h4>
          <h6 class="text-center">{t('titleDevPosition')}</h6>
          <LanguageSelector />
          <SidebarMenu />
        </div>
      </aside>
